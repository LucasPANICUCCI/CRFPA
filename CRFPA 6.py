...
# 🎯 GIF motivant fonctionnel
st.markdown("### 🔥 Rappelle-toi :")

# GIF hébergé et fonctionnel
gif_url = "https://media.tenor.com/Yjoz3bU8Bk4AAAAC/you-got-this-motivation.gif"
st.image(gif_url, caption="✨ JE VAIS RÉUSSIR ✨", use_container_width=True)
